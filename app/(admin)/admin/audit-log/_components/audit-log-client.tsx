...
const ACTION_STYLES: Record<string, { icon: typeof Activity; color: string; bg: string }> = {
  ...
  PASSWORD_RESET_EMAIL_REQUESTED: { icon: Key, color: "text-indigo-600", bg: "bg-indigo-50" },
  PASSWORD_RESET_EMAIL_COMPLETED: { icon: Key, color: "text-green-600", bg: "bg-green-50" },
...
const ACTION_LABELS: Record<string, string> = {
  ...
  PASSWORD_RESET_EMAIL_REQUESTED: "Link Reset Diminta",
  PASSWORD_RESET_EMAIL_COMPLETED: "Password Direset via Email",
